...
thinks_about_job,
wants_to_go_home, % gets_into_car_at_work 
drives_home1,
drives_home1,  % arrives_home_in_8_min 
car_goes_on_bumpy_road2,
car_gets_shaken2,
hears_noise_from_car, 
/* wants_to_find_noise,*/ stops_car1, 
goes_towards_noise,
sees_something,
/* sees_mechanical_problem,sees_rock,*/ resolves_mechanical_problem,
drives_home2,
...
turns_off_motor,
wants_to_know_what_to_do,
countdown_goes_on, % countdown is 0:22
thinks_about_alternative1,
countdown_goes_on, % countdown is 0:13
thinks_about_alternative2,
